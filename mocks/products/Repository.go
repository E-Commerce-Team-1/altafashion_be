...
// ShowAll provides a mock function with given fields: category, name, page
func (_m *Repository) ShowAll(category string, name string, page int) ([]domain.Core, error) {
...
// ShowDetail provides a mock function with given fields: ID
func (_m *Repository) ShowDetail(ID uint) (domain.Core, error) {
	ret := _m.Called(ID)
